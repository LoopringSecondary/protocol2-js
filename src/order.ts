  ...
  public toTypedData(order: OrderInfo) {
    const typedData = {
      ...
      message: {
        ...
        trancheS: order.trancheS ? order.trancheS : "0x0",
        trancheB: order.trancheB ? order.trancheB : "0x0",
        transferDataS: new Buffer(order.transferDataS ? order.transferDataS.slice(2) : "", "hex"),
      },
    };
    return typedData;
  }
